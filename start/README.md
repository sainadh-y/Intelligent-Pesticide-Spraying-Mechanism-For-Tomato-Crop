...
- in this launcher, each plant run does its own phase-1 positioning move
- phase 7 is now spray-only; inter-plant movement is handled at the start of the next plant run
